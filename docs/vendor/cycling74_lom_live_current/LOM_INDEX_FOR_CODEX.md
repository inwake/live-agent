# LOM_INDEX_FOR_CODEX
Generated from the cleaned Firecrawl markdown export of Cycling '74 Live Object Model docs. This is a compact navigation/index file for Codex so it does not have to read every full LOM page for basic planning.
## Project focus
